...
var handleCitySearch = function handleCitySearch(cityInput) {
...
function handleLocationDetails(entityID) {
    // var entityID = 
    var loactionsURL = "https://developers.zomato.com/api/v2.1/location_details?entity_id=" + entityID + "&entity_type=group";
